...
namespace Acomes
{
    public partial class about_us_teacher : Form
    {
        MySqlConnection conn = new MySqlConnection();
        public static setingTeacher seting;
        private string NIK;
        public about_us_teacher()
        {
            InitializeComponent();
        }
        public about_us_teacher(String NIK)
        {
            InitializeComponent();
            this.NIK = NIK;
        }
        ...
        private void about_us_teacher_Load(object sender, EventArgs e)
        {
            koneksi();
