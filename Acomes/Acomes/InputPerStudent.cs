...
namespace Acomes
{
    public partial class InputPerStudent : Form
    {
        MySqlConnection conn = new MySqlConnection();
        public static InputNilai back;
        private String NIK;
        public InputPerStudent()
        {
            InitializeComponent();
        }
        public InputPerStudent(String NIK)
        {
            InitializeComponent();
            this.NIK = NIK;
        }
        ...
        private void InputPerStudent_Load(object sender, EventArgs e)
        {
            koneksi();
